...
<body >
    ...
    <div class="card" id="card-login">
    	<div class="box">
        	<form method="post" class="form-signin" action="<?php echo site_url('Petugas/Proses_Login') ?>" class="form-group">
            ...
            <div class="or-box">
                    <span class="or">Login Sebagai &nbsp;<i class="fa fa-user-secret"></i>Admin</span>
                    <div class="row">
